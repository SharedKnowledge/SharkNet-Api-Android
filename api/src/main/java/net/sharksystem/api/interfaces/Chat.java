...
public interface Chat extends Timeable {
    ...
    void sendMessage(InputStream inputStream, String message, String mimetype, long date) throws JSONException, SharkKBException;
    ...
    void sendMessage(InputStream inputStream, String message, String mimetype, Contact sender, long date) throws JSONException, SharkKBException;
