package net.sharksystem.api.shark.protocols.nfc.readerWriterMode;
...
import net.sharksystem.api.shark.protocols.nfc.androidService.SmartCardEmulationService;
...
public class IsoDepTransceiver implements Runnable {
    ...
    public static final byte[] AID_ANDROID = {(byte) 0xF0, 0x01, 0x02, 0x03, 0x06, 0x06, 0x07}; // needs to be equal host-apdu-service > aid-filter
