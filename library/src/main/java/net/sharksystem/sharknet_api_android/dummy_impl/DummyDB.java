...
public class DummyDB {
	 ...
	 * @return
	 */
	public List<Feed> getFeed_list(Profile owner, boolean descending) throws SharkKBException {
	...
	public List<Feed> getFeed_list(Profile owner, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
	...
	public List<Feed> getFeed_list(Profile owner, String search, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
		List <Feed> swaplist = (List<Feed>) sortList(getFeed_list(owner, descending), descending);
	...
	public List<Feed> getFeed_list(Profile owner, Interest i, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
		List <Feed> swaplist = (List<Feed>) sortList(getFeed_list(owner, descending), descending);
	...
	public List<Feed> getFeed_list(Profile owner, int startIndex, int stopIndex, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
		List <Feed> swaplist = (List<Feed>) sortList(getFeed_list(owner, descending), descending);
	...
	public List<Feed> getFeed_list(Profile owner, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
		List <Feed> swaplist = (List<Feed>) sortList(getFeed_list(owner, descending), descending);
		swaplist = (List<Feed>) cutList(swaplist, start, stop);
		return swaplist;
	}
...
//Comments Lists and Values
	 ...
	 * @return
     */
	public List<Comment> getComments(Feed f, boolean descending) throws SharkKBException {
	 ...
	 * @return
	 */
	public List<Comment> getComments(Feed f, int startIndex, int stopIndex, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
	 ...
	 * @return
	 */
	public List<Comment> getComments(Feed f, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
		List <Comment> swaplist = (List<Comment>) sortList(feedcomment.get(f), descending);
		swaplist = (List<Comment>) cutList(swaplist, startIndex, stopIndex);
		return swaplist;
	}
	 ...
	 * @return
	 */
	public List<Comment> getComments(Feed f, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
		List <Comment> swaplist = (List<Comment>) sortList(feedcomment.get(f), descending);
		swaplist = (List<Comment>) cutList(swaplist, start, stop);
		return swaplist;
	}
	 ...
	 * @return
	 */
	public List<Comment> getComments(Feed f, String search, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
		List <Comment> swaplist = (List<Comment>) sortList(feedcomment.get(f), descending);
	...
	public List<Chat> getChat_list(Profile owner) throws SharkKBException {
...
//Manage the Messages Lists
	 ...
	 * @return
     */
	public List<Message> getMessageList(Chat c, boolean descending) throws SharkKBException {
	 ...
	 * @return
	 */
	public List<Message> getMessageList(Chat c, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
	 ...
	 * @return
	 */
	public List<Message> getMessageList(Chat c, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
		List <Message> swapmessages = (List<Message>) sortList(chatmessage.get(c), descending);
	 ...
	 * @return
	 */
	public List<Message> getMessageList(Chat c, int startIndex, int stopIndex, Timestamp start, Timestamp stop, boolean descending) throws SharkKBException {
	 ...
	 * @return
	 */
	public List<Message> getMessageList(Chat c, String search, int startIndex, int stopIndex, boolean descending) throws SharkKBException {
		List <Message> swapmessages = (List<Message>) sortList(chatmessage.get(c), descending);
...
//Methods to Manage list-stuff
	 ...
	 * @return
	 */
	private List<? extends Timeable> sortList(List<? extends Timeable> sortlist, boolean ascending) throws SharkKBException {
