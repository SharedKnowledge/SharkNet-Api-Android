...
public class ImplInterest implements net.sharksystem.sharknet_api_android.interfaces.Interest {
	...
	@Override
	public boolean contains(net.sharksystem.sharknet_api_android.interfaces.Interest i) {
